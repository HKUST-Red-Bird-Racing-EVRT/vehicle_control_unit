...
void setup()
{
    ...
    DBGLN_GENERAL("[setup] Serial debug initialized");
    DBGLN_GENERAL("[setup] Starting startup sequence");
#endif

    DBGLN_GENERAL("[setup] Initializing MCP2515 controllers");
    ...
    DBGLN_GENERAL("[setup] MCP2515 controllers ready");

    // init GPIO pins (MCP2515 CS pins initialized in constructor))
    DBGLN_GENERAL("[setup] Initializing GPIO");
